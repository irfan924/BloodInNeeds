...
function EshaDetailScreen({ navigation }) {
...
{Data.map((item)=>(
  <View>
      <Text style={{ color: 'black', width: '80%', borderBottomWidth: 0.9, alignSelf: 'center', marginTop: '10%' }}>{item.name}</Text>
      <Text style={{ color: 'black', width: '80%', borderBottomWidth: 0.9, alignSelf: 'center', marginTop: '9%' }}>{item.phone}</Text>
      <Text style={{ color: 'black', width: '80%', borderBottomWidth: 0.9, alignSelf: 'center', marginTop: '9%' }}>{item.date}</Text>
      <Text style={{ color: 'black', width: '80%', borderBottomWidth: 0.9, alignSelf: 'center', marginTop: '9%' }}>{item.name}</Text>
      </View>
    )) }
...
export default EshaDetailScreen;
